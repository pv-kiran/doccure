...
router.post('/patient/create/:doctorId' , isLoggedIn ,isPatient , async (req, res) => {
  {
  try {
...
router.post('/doctor/create/:patientId' , isLoggedIn ,isDoctor , async (req, res) => {
  {
  try {
...
router.get('/mychat', isLoggedIn , async (req, res) => {
    try {
